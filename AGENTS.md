...
- **Do not run npm.** No `npm run compile`, `compile_open`, `compile:hot`, `server_build`, `server_local_host`, `server_shutdown`, or other npm scripts. The user compiles, opens the editor, and starts/stops the server.
